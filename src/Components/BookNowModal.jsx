...
const bookingOptions = [
  {
    name: 'Booking.com',
    link: 'https://www.booking.com/hotel/in/pvt-residency.en-gb.html', // Current link from Rooms.jsx
    color: '#003580'
  },
  {
    name: 'Agoda',
    link: 'https://www.agoda.com/en-in/pvt-residency/hotel/palani-in.html?cid=1844104&ds=i22iqZC8PCBz%2BNxr', // Replace with actual Agoda link
    color: '#5392F9'
  },
  {
    name: 'MakeMyTrip',
    link: 'https://www.makemytrip.com/hotels/pvt_residency-details-palani.html', // Replace with actual MakeMyTrip link
    color: '#d0021b'
  },
  {
    name: 'Goibibo',
    link: 'https://www.goibibo.com/hotels/pvt-residency-hotel-in-palani-6276096588097271153/', // Replace with actual Goibibo link
    color: '#2276E3'
  }
];
  ...
  return (
    <Modal show={show} onHide={handleClose} centered size="lg" className="book-now-modal">
      ...
      <Modal.Body className="px-4 py-4">
        <p className="text-center mb-4 text-muted">Select an option below to secure your reservation at PVT Residency.</p>
        ...
        <Row className="g-4 justify-content-center">
          ...
          <Col xs={12} sm={12} md={12} lg={12} className="mt-4">
            <div className="direct-call-card shadow-sm p-4 d-flex flex-column flex-md-row align-items-center justify-content-between text-center text-md-start">
              ...
              <a href="tel:+919952161959" className="btn btn-primary pulse-btn d-flex align-items-center justify-content-center px-4 py-3 rounded-pill shadow">
                <i className="bi bi-telephone-fill me-2 fs-5"></i>
                <span className="fw-bold fs-5">+91 99521-61959</span>
              </a>
            </div>
          </Col>
        </Row>
